<template>
  ...
  <div>
    <v-app-bar app color="white" height="55" class="elevation-0">
      ...
      <v-img
        src="/assets/neighborhood_pos/js/posapp/components/pos/logo.png"
        alt="POS"
        max-width="32"
        class="mx-3"
        @click="go_desk"
      ...
      <v-toolbar-title
        ...
        @click="go_desk"
      >
        <span class="font-weight-light primary--text">Neighborhood</span>
    ...
    >
      ...
      >
        <v-list-item @click="goToDashboard()">
          <v-img
            class="img pl-1"
            src="/assets/neighborhood_pos/js/posapp/components/pos/dashboard.png"
            alt=""
            cover
        ...
        <v-list-item class="mt-4" @click="goToHoldOrder()">
          <v-img
            class="img pl-1"
            src="/assets/neighborhood_pos/js/posapp/components/pos/receipt.png"
            alt=""
            cover
            style="width: 38px; height: 40px"
          ></v-img>
        ...
        <v-list-item class="mt-4" @click="goToOrderHistory()">
          <v-img
            class="img pl-1"
            src="/assets/neighborhood_pos/js/posapp/components/pos/store.png"
            alt=""
            cover
            style="width: 38px; height: 40px"
          ></v-img>
