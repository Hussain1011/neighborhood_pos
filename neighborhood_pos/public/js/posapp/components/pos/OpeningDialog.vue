...
export default {
    ...
    pos_profile(val) {
      ...
      this.payments_method_data.forEach((element) => {
        if (element.parent === val) {
          // Find the corresponding balance for the selected POS profile
          const balanceEntry = this.branch_account_balances.find(
  ...
  methods: {
    ...
    get_opening_dialog_data() {
      const vm = this;
      frappe.call({
        method: "neighborhood_pos.neighborhood_pos.api.posapp.get_opening_dialog_data",
        args: {},
        callback: function (r) {
          if (r.message) {
            ...
            vm.branch_account_balances = r.message.branch_account_balances;
          }
        },
      });
    },
    submit_dialog() {
      ...
      const vm = this;
      return frappe
        .call("neighborhood_pos.neighborhood_pos.api.posapp.create_opening_voucher", {
