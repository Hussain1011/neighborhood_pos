...
frappe.ui.form.on('POS Closing Shift', {
	...
	get_pos_invoices (frm) {
		frappe.call({
			method: 'neighborhood_pos.neighborhood_pos.doctype.pos_closing_shift.pos_closing_shift.get_pos_invoices',
			args: {
	...
	get_pos_payments (frm) {
		frappe.call({
			method: 'neighborhood_pos.neighborhood_pos.doctype.pos_closing_shift.pos_closing_shift.get_payments_entries',
			args: {
				pos_opening_shift: frm.doc.pos_opening_shift,
			},
			callback: (r) => {
