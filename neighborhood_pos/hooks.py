...
app_name = "neighborhood_pos"
app_title = "Neighborhood Pos"
app_publisher = "Hussain"
app_description = "Neighborhood Pos"
...
# app_include_css = "/assets/neighborhood_pos/css/neighborhood_pos.css"
# app_include_js = "/assets/neighborhood_pos/js/neighborhood_pos.js"
app_include_js = [
    # "/assets/neighborhood_pos/node_modules/vuetify/dist/vuetify.js",
    "neighborhood_pos.bundle.js",
]

# include js, css files in header of web template
# web_include_css = "/assets/neighborhood_pos/css/neighborhood_pos.css"
# web_include_js = "/assets/neighborhood_pos/js/neighborhood_pos.js"
...
doctype_js = {
    "POS Profile": "neighborhood_pos/api/pos_profile.js",
    "Sales Invoice": "neighborhood_pos/api/invoice.js",
    "Company": "neighborhood_pos/api/company.js",
}
...
# get_website_user_home_page = "neighborhood_pos.utils.get_home_page"
...
# before_install = "neighborhood_pos.install.before_install"
# after_install = "neighborhood_pos.install.after_install"
# before_uninstall = "neighborhood_pos.uninstall.before_uninstall"
after_uninstall = "neighborhood_pos.uninstall.after_uninstall"

# Desk Notifications
# ------------------
# See frappe.core.notifications.get_notification_config

# notification_config = "neighborhood_pos.notifications.get_notification_config"
...
doc_events = {
    "Branch": {
		"validate": "neighborhood_pos.custom.branch_lucrum_pos.validate"
	},
    "Sales Invoice": {
        "validate": "neighborhood_pos.neighborhood_pos.api.invoice.validate",
        "before_submit": "neighborhood_pos.neighborhood_pos.api.invoice.before_submit",
        "before_cancel": "neighborhood_pos.neighborhood_pos.api.invoice.before_cancel",
        "on_submit":"neighborhood_pos.custom.sales_invoice_custom.on_submit",
    },
    "Customer": {
        "validate": "neighborhood_pos.neighborhood_pos.api.customer.validate",
        "after_insert": "neighborhood_pos.neighborhood_pos.api.customer.after_insert",
    },
    "Stock Entry": {
		"before_validate": "neighborhood_pos.custom.stock_entry_lucrum_pos.before_validate",
		"on_update": "neighborhood_pos.custom.stock_entry_lucrum_pos.on_update",
		"on_update_after_submit": "neighborhood_pos.custom.stock_entry_lucrum_pos.on_update_after_submit",
	}
}
...
# scheduler_events = {
# 	"all": [
# 		"neighborhood_pos.tasks.all"
# 	],
# 	"daily": [
# 		"neighborhood_pos.tasks.daily"
# 	],
# 	"hourly": [
# 		"neighborhood_pos.tasks.hourly"
# 	],
# 	"weekly": [
# 		"neighborhood_pos.tasks.weekly"
# 	]
# 	"monthly": [
# 		"neighborhood_pos.tasks.monthly"
# 	]
# }
...
# before_tests = "neighborhood_pos.install.before_tests"

# Overriding Methods
# ------------------------------
#
# override_whitelisted_methods = {
# 	"frappe.desk.doctype.event.event.get_events": "neighborhood_pos.event.get_events"
# }
#
...
# 	"Task": "neighborhood_pos.task.get_dashboard_data"
# }
